!function(e) {
    ...
    o = function() {
        ...
        t.find("option").each((t,n)=>{
            ...
            a && o.attr("data-content", "<img src='%i'/> %s".replace(/%i/, a).replace(/%s/, o.text())),
            console.warn("option:", t, o)
        }
        ),
        t.selectpicker()
    }
        ...
        init: function() {
            ...
            function() {
                for (var t = window.location, n = e("ul#menu a").filter(function() {
                    return this.href == t
                }).addClass("mm-active").parent().addClass("mm-active"); n.is("li"); )
                    n = n.parent().addClass("mm-show").parent().addClass("mm-active")
            }(),
            e("ul#menu>li").on("click", function() {
                "mini" === e("body").attr("data-sidebar-style") && (console.log(e(this).find("ul")),
                e(this).find("ul").stop())
            }),
            a = window.outerHeight,
            ((a = window.outerHeight) > 0 ? a : screen.height) && e(".content-body").css("min-height", a + 60 + "px"),
